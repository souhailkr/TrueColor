...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE IF NOT EXISTS " + TABLE_QUEST + " ( "
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_ANSWER+ " TEXT, "+KEY_OPTA +" TEXT, "
    ...
    private void addQuestions()
    {
        ...
        Question q6=new Question("9", "2 ", "3", "5","5");
        this.addQuestion(q6);

        Question q7=new Question("0", "5", "3", "8","3");
        this.addQuestion(q7);

        Question q8=new Question("5", "8", "17", "9","15");
        this.addQuestion(q8);

        Question q9=new Question("2", "21", "74", "4","74");
        this.addQuestion(q9);
        ...
        Question q22=new Question("9", "2", "6", "26","26");
        this.addQuestion(q22);

        Question q23=new Question("9", "2", "4", "42","42");
        this.addQuestion(q23);

        Question q24=new Question("20", "3", "5", "35","35");
        this.addQuestion(q24);

        Question q25=new Question("96", "50", "6", "9","96");
        this.addQuestion(q25);

        Question q26=new Question("tracés pourpre et rouge", "tracé pourpe", "tracé rouge", "tracé gris","tracés pourpre et rouge");
        this.addQuestion(q26);

        Question q27=new Question("0", "9", "3", "8","3");
